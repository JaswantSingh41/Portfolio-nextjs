      ...
      <div>
        ...
        <div>
          ...
          <div className="flex flex-row gap-4">
            <Link href="https://github.com/JaswantSingh41" target="_blank" rel="noopener noreferrer">
              <FaGithub />
            </Link>
            <Link href="https://www.linkedin.com/in/JaswantSingh41/" target="_blank" rel="noopener noreferrer">
              <FaLinkedinIn />
            </Link>
          </div>
        </div>
